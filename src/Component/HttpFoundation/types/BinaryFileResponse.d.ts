declare namespace Jymfony.Component.HttpFoundation {
    ...
    export class BinaryFileResponse extends Response {
         ...
         * @inheritdoc
         */
        prepare(request: Request): Promise<BinaryFileResponse>;
         ...
         */
        setFile(file: File | string, contentDisposition?: string | number, autoEtag?: boolean, autoLastModified?: boolean): BinaryFileResponse;

        /**
         * Automatically sets the ETag header according to the checksum of the file.
         */
        setAutoEtag(): BinaryFileResponse;

        /**
         * Automatically sets the Last-Modified header according the file modification date.
         */
        setAutoLastModified(): BinaryFileResponse;
         ...
         */
        setContentDisposition(disposition: string, filename?: string, filenameFallback?: string): BinaryFileResponse;
    }
}
